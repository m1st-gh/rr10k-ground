...
def animate(frame, ser, axs):
    ...
    axs[0, 0].plot(data[9], data[0], label="x", color="red")
    axs[0, 0].plot(data[9], data[1], label="y", color="blue")
    axs[1, 0].plot(data[9], data[2], label="x", color="red")
    axs[1, 0].plot(data[9], data[3], label="z", color="blue")
    axs[1, 0].plot(data[9], data[4], label="z", color="green")
    axs[2, 0].plot(data[9], data[5], label="Atm", color="blue")
    axs[0, 1].plot(data[9], data[6], label="Temp", color="black")
    axs[1, 1].plot(data[9], data[7], label="Alt", color="black")
    axs[2, 1].plot(data[9], data[8], label="heading", color="black")
